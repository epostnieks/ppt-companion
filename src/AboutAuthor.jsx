  ...
  return (
    <div style={{ minHeight: "100vh", background: BG, color: TEXT, fontFamily: S, padding: "32px 24px 80px" }}>
      <div style={{ maxWidth: 780, margin: "0 auto" }}>
        ...
        {/* HEADER WITH PHOTO */}
        <div style={{ marginBottom: 40, display: "flex", gap: 32, alignItems: "flex-start", flexWrap: "wrap" }}>
          <img
          ...
          <div style={{ flex: 1, minWidth: 240 }}>
            ...
            <div style={{ fontFamily: S, fontSize: 20, color: DIM, marginTop: 8, fontStyle: "italic" }}>
              Economist &middot; Quantitative Fund Manager &middot; Independent Researcher
            </div>
          </div>
        </div>
        ...
        <Section label="THE SYSTEM ASSET PRICING MODEL PROGRAM — 2025&ndash;2026">
          ...
          <p style={{ margin: "0 0 14px" }}>
            The foundational result is the Private Pareto Theorem &mdash; the 18th impossibility theorem in economics &mdash; which proves that bilateral efficiency and system welfare preservation are structurally incompatible under three minimal axioms. The program calibrates the welfare beta (&beta;<sub>W</sub>) across 61 domains via Monte Carlo simulation, identifying $85.3 trillion in annual welfare destruction &mdash; approximately 83% of global GDP.
          </p>
          <p style={{ margin: "0 0 14px" }}>
        ...
        <Section label="PUBLICATIONS — 75 WORKING PAPERS (2025&ndash;2026)">
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            {[
              ...
              { cat: "IMPOSSIBILITY THEOREMS (22 PAPERS)", papers: [
                "Forever Chemicals / Molecular Persistence Floor", "Antimicrobial Resistance / Resistance Ratchet", "Nuclear / Fission Product Persistence",
              ...
              { cat: "INTRACTABILITY THEOREMS (39 PAPERS)", papers: [
                ...
                "Alcohol / Excise Dependency Trap", "Gig Economy / Classification Arbitrage",
                "Orbital Debris / Kessler Cascade Threshold",
              ].map(p => typeof p === "string" ? { title: p, ssrn: "https://ssrn.com/abstract=" } : p) },
            ].map(group => (
              <div key={group.cat} style={{ marginBottom: 16 }}>
                <div style={{ fontFamily: M, fontSize: 11, color: GOLD, letterSpacing: 1, marginBottom: 6 }}>{group.cat}</div>
...
{`@unpublished{postnieks2026ppt,
  ...
  note = {Working paper}
            ...
            <div style={{ padding: "14px 18px", background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: 4 }}>
              ...
              <div style={{ fontFamily: M, fontSize: 13, color: DIM, lineHeight: 1.7 }}>
                Postnieks, E. (2026). The System Asset Pricing Model program: 62 theorems across 61 domains. Available at https://ppt-companion.vercel.app. Monte Carlo replications at https://github.com/epostnieks/sapm-mc-[slug].
              </div>
            </div>
          </div>
        </Section>
        ...
        <Section label="ACADEMIC CORRESPONDENCE">
          <p style={{ margin: 0 }}>
            For academic correspondence, collaboration inquiries, or peer review requests, contact through the GitHub repositories linked from each paper's Monte Carlo replication page. All 61 repositories accept issues and pull requests.
          </p>
        </Section>
        ...
        <div style={{
          ...
          &copy; 2026 Erik Postnieks &middot; Independent Researcher &middot; Salt Lake City
        </div>
      </div>
    </div>
  );
