...
const DOMAINS = [
  { name: "WMD Capability Diffusion", beta: 79512, welfCost: 6871353, pi: 90, jurisdiction: ["Department of Defense (DOD)","State Dept.","National Security Council (NSC)","International Atomic Energy Agency (IAEA)","Chemical Weapons Convention (CWC) / Biological Weapons Convention (BWC)"], addressable: "low", urgency: "critical",
  ...
  { name: "Orbital Debris", beta: 5066, welfCost: 1483003, pi: 300, jurisdiction: ["Federal Communications Commission (FCC)","Federal Aviation Administration (FAA)","United Nations Committee on the Peaceful Uses of Outer Space (UN COPUOS)","International Telecommunication Union (ITU)"], addressable: "medium", urgency: "critical",
  ...
  { name: "Gene Drives", beta: 12.4, welfCost: 37, pi: 3, jurisdiction: ["Environmental Protection Agency (EPA)","Food and Drug Administration (FDA)","US Dept. of Agriculture (USDA)","Convention on Biological Diversity (CBD)","Cartagena Protocol"], addressable: "high", urgency: "high",
  ...
  { name: "Pharmacy Benefit Managers", beta: 6.3, welfCost: 174, pi: 28, jurisdiction: ["Federal Trade Commission (FTC)","Health and Human Services (HHS)","Centers for Medicare & Medicaid Services (CMS)","State Attorneys General"], addressable: "very high", urgency: "high",
  ...
  { name: "PFAS / Forever Chemicals", beta: 35.2, welfCost: 6582, pi: 187, jurisdiction: ["EPA","FDA","DOD","European Chemicals Agency (ECHA)","Stockholm Convention"], addressable: "high", urgency: "critical",
    ...
    existing: ["EPA PFAS Strategic Roadmap (2021)","CERCLA designation (PFOA/PFOS, 2024)","EU PFAS restriction proposal (ECHA, 2023)","Stockholm Convention listings"],
  ...
  { name: "Opioid Ecosystem", beta: 12.5, welfCost: 304, pi: 25, jurisdiction: ["Drug Enforcement Administration (DEA)","FDA","HHS","Substance Abuse and Mental Health Services Administration (SAMHSA)","State Attorneys General"], addressable: "medium", urgency: "high",
  ...
  { name: "Palm Oil Deforestation", beta: 6.2, welfCost: 415, pi: 67, jurisdiction: ["USDA","EU Deforestation Regulation","Roundtable on Sustainable Palm Oil (RSPO)","Indonesia/Malaysia national"], addressable: "medium", urgency: "high",
  ...
  { name: "Industrial Monoculture", beta: 8.6, welfCost: 447, pi: 52, jurisdiction: ["USDA","EPA","Food and Agriculture Organization (FAO)","Convention on Biological Diversity"], addressable: "medium", urgency: "high",
  ...
  { name: "Gambling", beta: 7.2, welfCost: 318, pi: 45, jurisdiction: ["State Gaming Commissions","FTC","Consumer Financial Protection Bureau (CFPB)","UK Gambling Commission"], addressable: "high", urgency: "medium",
  ...
  { name: "Coal Combustion", beta: 7.0, welfCost: 6861, pi: 999, jurisdiction: ["EPA","Department of Energy (DOE)","United Nations Framework Convention on Climate Change (UNFCCC)","International Energy Agency (IEA)"], addressable: "medium", urgency: "critical",
    ...
    existing: ["EPA Clean Power Plan (revised)","Paris Agreement NDCs","EU ETS","Powering Past Coal Alliance"],
  ...
  { name: "Oil & Gas Extraction", beta: 6.6, welfCost: 22926, pi: 3507, jurisdiction: ["EPA","Department of the Interior / Bureau of Land Management (DOI/BLM)","Federal Energy Regulatory Commission (FERC)","Organization of the Petroleum Exporting Countries (OPEC)","UNFCCC"], addressable: "medium", urgency: "critical",
  ...
  { name: "Cement (Calcination Floor)", beta: 6.6, welfCost: 2144, pi: 330, jurisdiction: ["EPA","EU Emissions Trading System","Carbon Border Adjustment Mechanism","ISO"], addressable: "low", urgency: "medium",
    ...
    existing: ["EU CBAM (2023, transitional)","EPA cement National Emission Standards for Hazardous Air Pollutants","General Services Administration (GSA) Buy Clean","EU ETS Phase IV"],
  ...
  { name: "Ultra-Processed Food", beta: 6.7, welfCost: 2010, pi: 300, jurisdiction: ["FDA","USDA","FTC","World Health Organization (WHO)","Codex Alimentarius (international food standards)"], addressable: "high", urgency: "high",
  ...
  { name: "POPs Beyond PFAS", beta: 6.1, welfCost: 419, pi: 70, jurisdiction: ["EPA","European Chemicals Agency","Stockholm Convention","Basel Convention"], addressable: "medium", urgency: "medium",
  ...
  { name: "Topsoil Erosion", beta: 6.8, welfCost: 1735, pi: 255, jurisdiction: ["USDA Natural Resources Conservation Service","EPA","Food and Agriculture Organization","United Nations Convention to Combat Desertification"], addressable: "medium", urgency: "high",
    ...
    committee: { us: "Agriculture; Appropriations", eu: "Agriculture; Environment & Public Health" } },
  { name: "Algorithmic Pricing", beta: 5.3, welfCost: 208, pi: 40, jurisdiction: ["FTC","DOJ","European Commission Competition Directorate","State Attorneys General"], addressable: "very high", urgency: "medium",
  ...
  { name: "Aviation Emissions", beta: 4.9, welfCost: 4987, pi: 1025, jurisdiction: ["FAA","International Civil Aviation Organization (ICAO)","EPA","EU Emissions Trading System"], addressable: "low", urgency: "medium",
    ...
    existing: ["ICAO carbon offsetting scheme (CORSIA, 2027 mandatory phase)","EU ReFuelEU Aviation (2025)","EU ETS aviation (intra-EU)"],
  ...
  { name: "Student Loan Securitization", beta: 4.80, welfCost: 227, pi: 48, jurisdiction: ["Department of Education","Consumer Financial Protection Bureau (CFPB)","SEC","FTC","State Attorneys General"], addressable: "high", urgency: "medium",
  ...
  { name: "Fisheries", beta: 4.8, welfCost: 177, pi: 38, jurisdiction: ["NOAA / National Marine Fisheries Service","Food and Agriculture Organization","Regional Fisheries Management Organizations (RFMOs)","UN Convention on the Law of the Sea"], addressable: "medium", urgency: "high",
  ...
  { name: "Gig Economy", beta: 4.6, welfCost: 286, pi: 64, jurisdiction: ["Department of Labor (DOL)","National Labor Relations Board (NLRB)","IRS","State Labor Agencies","EU"], addressable: "high", urgency: "medium",
  ...
  { name: "Water Privatization", beta: 4.2, welfCost: 1033, pi: 246, jurisdiction: ["EPA","State Public Utility Commissions","World Health Organization","World Bank"], addressable: "high", urgency: "medium",
  ...
  { name: "Arms Exports", beta: 2.5, welfCost: 742, pi: 296, jurisdiction: ["State Dept. Directorate of Defense Trade Controls","DOD Defense Security Cooperation Agency","Congress","Arms Trade Treaty","Wassenaar Arrangement"], addressable: "medium", urgency: "medium",
  ...
  { name: "Proof of Stake Protocols", beta: 2.1, welfCost: 38, pi: 18, jurisdiction: ["SEC","CFTC","EU Markets in Crypto-Assets Regulation"], addressable: "high", urgency: "low",
    ...
    existing: ["EU MiCA (2024)","SEC staking enforcement actions","CFTC digital commodity guidance"],
    gap: "Proof-of-Stake welfare costs are 97% lower than Proof-of-Work. β<sub>W</sub> = 2.1 — moderate. The primary risk is validator concentration, not energy. Not a priority domain. The system works when you compare it to proof of work.",
    committee: { us: "Financial Services; Agriculture (CFTC)", eu: "Economic Affairs" } },
  { name: "Nuclear Fission", beta: 0.53, welfCost: 23, pi: 44, jurisdiction: ["Nuclear Regulatory Commission (NRC)","Department of Energy","International Atomic Energy Agency","EPA"], addressable: "high", urgency: "low",
    intervention: "Licensing reform for advanced reactors. Spent fuel repository progress. Small modular reactor (SMR) deployment incentives. The only domain with β<sub>W</sub> below 1.0. Nuclear destroys less than one dollar of system welfare per dollar of private gain. The barriers are regulatory and political, not welfare-economic.",
  ...
  { name: "Frontier AI", beta: 7.4, welfCost: 666, pi: 90, jurisdiction: ["National Institute of Standards and Technology (NIST)","Department of Commerce Bureau of Industry and Security (BIS)","Federal Trade Commission (FTC)","Office of Science and Technology Policy (OSTP)","European Commission (EU AI Act)","UK AI Safety Institute","United Nations International Telecommunication Union (ITU)"], addressable: "medium", urgency: "critical",
  ...
  { name: "Groundwater / Ogallala Aquifer", beta: 12.0, welfCost: 180, pi: 15, jurisdiction: ["US Geological Survey (USGS)","State Water Boards","EPA","Bureau of Reclamation"], addressable: "low", urgency: "critical",
  ...
  { name: "Industrial Agriculture Methane", beta: 5.0, welfCost: 1400, pi: 280, jurisdiction: ["EPA","USDA","UNFCCC","Food and Agriculture Organization (FAO)"], addressable: "medium", urgency: "high",
  ...
  { name: "Private Equity in Healthcare", beta: 6.9, welfCost: 310, pi: 45, jurisdiction: ["FTC","HHS","CMS","SEC","State Attorneys General"], addressable: "high", urgency: "high",
  ...
  { name: "Social Media & Youth Mental Health", beta: 5.7, welfCost: 680, pi: 120, jurisdiction: ["FTC","FDA (if reclassified)","National Institute of Mental Health","EU Digital Services Act"], addressable: "high", urgency: "critical",
    ...
    existing: ["COPPA (1998, pre-social media)","UK Age Appropriate Design Code","EU Digital Services Act","US Surgeon General advisory (2023)","KOSA (proposed)"],
  ...
  { name: "Defense Procurement", beta: 3.6, welfCost: 650, pi: 180, jurisdiction: ["Department of Defense","Government Accountability Office (GAO)","Congressional Armed Services Committees"], addressable: "medium", urgency: "medium",
  ...
  { name: "Fast Fashion", beta: 6.9, welfCost: 380, pi: 55, jurisdiction: ["FTC","EPA","EU Strategy for Sustainable Textiles","International Labour Organization (ILO)"], addressable: "high", urgency: "medium",
  ...
  { name: "Mining & Rare Earth Extraction", beta: 6.1, welfCost: 520, pi: 85, jurisdiction: ["EPA","Bureau of Land Management","International Council on Mining and Metals","EU Critical Raw Materials Act"], addressable: "low", urgency: "high",
  ...
  { name: "Insurance & Climate Risk Mispricing", beta: 4.5, welfCost: 900, pi: 200, jurisdiction: ["State Insurance Commissioners","Federal Insurance Office (FIO)","FEMA/NFIP","Financial Stability Oversight Council (FSOC)"], addressable: "medium", urgency: "critical",
    intervention: "Actuarially accurate climate risk pricing. NFIP reform — close the $20.5B debt to Treasury. Managed retreat incentives for repetitive-loss properties. Federal reinsurance backstop with risk-accurate premiums.",
    existing: ["NFIP Risk Rating 2.0","State rate approval processes","TCFD/ISSB climate disclosure","Florida Hurricane Catastrophe Fund"],
    gap: "State Farm and Allstate have left California. Florida's property insurance market is collapsing. The NFIP owes $20.5B to the Treasury because it has never charged actuarially accurate rates. Climate risk is non-stationary — the historical loss distribution that actuarial tables rely on no longer describes the future. The models assume stationarity. The climate is not stationary.",
    committee: { us: "Financial Services; Banking; Appropriations; Budget", eu: "Economic Affairs; Environment & Public Health" } },
  { name: "Stablecoins & Shadow Banking", beta: 7.2, welfCost: 180, pi: 25, jurisdiction: ["SEC","CFTC","Treasury/OFR","Federal Reserve","Financial Stability Board"], addressable: "high", urgency: "high",
    ...
    existing: ["EU MiCA stablecoin provisions","US GENIUS Act (proposed)","NY BitLicense","FSB high-level recommendations on global stablecoins"],
  ...
  { name: "Shipping & Maritime Emissions", beta: 6.2, welfCost: 2800, pi: 450, jurisdiction: ["International Maritime Organization (IMO)","EPA","EU Emissions Trading System","Flag States"], addressable: "low", urgency: "high",
    ...
    existing: ["IMO MARPOL Annex VI (sulfur cap)","IMO GHG Reduction Strategy (2023)","EU ETS maritime inclusion (2024)","FuelEU Maritime"],
  ...
  { name: "Deforestation & Industrial Logging", beta: 7.1, welfCost: 850, pi: 120, jurisdiction: ["USDA Forest Service","EPA","EU Deforestation Regulation","UNFCCC REDD+","Convention on Biological Diversity"], addressable: "medium", urgency: "critical",
  ...
  { name: "Private Prisons & Carceral System", beta: 11.9, welfCost: 95, pi: 8, jurisdiction: ["Department of Justice (DOJ)","Bureau of Prisons","ICE","State Departments of Correction"], addressable: "very high", urgency: "medium",
  ...
  { name: "Sovereign Debt & Intergenerational Extraction", beta: 4.6, welfCost: 1600, pi: 350, jurisdiction: ["Treasury","Congressional Budget Office (CBO)","Federal Reserve","International Monetary Fund (IMF)","European Commission"], addressable: "low", urgency: "high",
  ...
  { name: "LIBOR / Financial Benchmark Manipulation", beta: 12.0, welfCost: 480, pi: 40, jurisdiction: ["SEC","CFTC","Financial Conduct Authority (FCA)","European Securities and Markets Authority (ESMA)","DOJ"], addressable: "high", urgency: "medium",
    ...
    existing: ["IOSCO Principles for Financial Benchmarks (2013)","EU Benchmarks Regulation","FCA BMR","LIBOR → SOFR transition"],
    gap: "LIBOR was manipulated for 30 years. $350 trillion in contracts referenced a rate set by the banks that traded on it. The referee was the player. SOFR eliminates the judgment-based submission, but credit-sensitive alternatives (term SOFR, BSBY) reintroduce self-referential structure. Goodhart's Law applies: when a measure becomes a target, it ceases to be a good measure. The structural impossibility is not LIBOR-specific. It is benchmark-specific.",
            ...
            {[
              ...
              { who: "FEDERAL AGENCY STAFF (EPA, FTC, SEC, FDA)",
                steps: [
                  ...
                  "Cross-reference with other agencies. Oil & Gas involves EPA, DOI, FERC, and UNFCCC. PFAS involves EPA, FDA, DOD, ECHA, and the Stockholm Convention. No high-β domain is single-agency.",
                ]},
              ...
              { who: "EUROPEAN PARLIAMENT / COMMISSION",
                steps: [
                  "The EU leads on Big Tech (DMA), Palm Oil (EUDR), PFAS (ECHA restriction), Crypto (MiCA), Gig Economy (Platform Work Directive), and Climate (ETS/CBAM).",
                  "Use βW to prioritize which existing regulations need strengthening. DMA covers gatekeepers — but validator concentration in PoS and algorithmic pricing coordination are not yet addressed.",
                  "CBAM applies to cement, steel, and aluminum. Extend it to coal-intensive imports and high-β agricultural commodities.",
                ]},
              { who: "INTERNATIONAL BODIES (UN, WHO, FAO, IAEA)",
                steps: [
                  ...
                  "βW is the argument for treaty prioritization. Higher β means the commons is being destroyed faster per dollar of private gain. WMD is 79,512. Orbital Debris is 5,066. Gene Drives is 42.5. The numbers do the work.",
                ]},
            ].map(section => (
