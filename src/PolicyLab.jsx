...
const DOMAINS = [
  ...
  { name: "Insurance & Climate Risk Mispricing", beta: 4.5, welfCost: 900, pi: 200, jurisdiction: ["State Insurance Commissioners","Federal Insurance Office (FIO)","FEMA / National Flood Insurance Program (NFIP)","Financial Stability Oversight Council (FSOC)"], addressable: "medium", urgency: "critical",
