...
const TREATIES = [
  ...
  { name: "Arms Trade Treaty (2013)", domain: "Arms Exports", status: "Weak", coverage: "113 parties (not US, Russia, China)",
    lesson: "The three largest arms exporters either did not ratify or did not sign. Reporting requirements are voluntary. The Treaty is a case study in what happens when the players whose defection matters most are the ones who defect. The underlying mechanism is the one the Private Pareto Theorem describes in formal terms: each exporter's bilateral calculation &mdash; private payoff from the sale &mdash; does not carry the system variable &mdash; regional stability, conflict casualties, displaced populations. Private-Systemic Tension-2 holds at the international level.",
...
const COORDINATION = [
  ...
  { scenario: "Coordination Game",
    ...
    evidence: "The Montreal Protocol is the clearest historical example. Once coordination was achieved &mdash; with trade sanctions for non-compliance and a dedicated transition-funding mechanism &mdash; universal participation followed, and the ozone hole has been healing. The problem was never that countries wanted to destroy the ozone layer. The problem was that bilateral optimisation &mdash; chlorofluorocarbons (CFCs) are cheap and effective &mdash; produced system destruction as a structural byproduct. This is the mechanism the Private Pareto Theorem formalises." },
  { scenario: "Asymmetric Exposure",
    description: "Countries differ substantially in their Hollow Win concentration. Preliminary allocation of the sixty-one System Asset Pricing Model domains across national production, using production-share weights from the c-adjusted-GDP database covering 190 countries (see the Reform Pathfinder), yields Saudi Arabia at approximately 55% (Oil & Gas dominant), Indonesia at approximately 32% (Palm Oil plus Coal), and Germany at approximately 13% (more diversified, lower exposure). Transition costs rise as diversification falls. Figures are point estimates on a preliminary panel; domain-level confidence intervals are reported in the underlying papers.",
  ...
  { scenario: "China's Position",
    description: "China is the world's largest producer in several high-β\u1D42 domains: coal (β\u1D42 ≈ 6.95), cement (β\u1D42 ≈ 6.74), Forever Chemicals (β\u1D42 ≈ 5.31), rare earth processing. Preliminary allocation of the sixty-one System Asset Pricing Model domains across China's economy, using production-share weights from World Bank sectoral data, suggests that on the order of twenty percent of nominal GDP corresponds to high-β\u1D42 sectors. The allocation has not been independently verified and the confidence intervals are wide.",
    opportunity: "China's 14th Five-Year Plan already targets coal peak by 2030 and carbon neutrality by 2060. The System Asset Pricing Model calibration is consistent with those targets in the sense that it values the underlying system-welfare costs explicitly. The reframing available to policymakers is balance-sheet rather than rhetorical: a portion of measured GDP corresponds to activity whose system-welfare cost, on the program's methodology, exceeds its private revenue. Whether that reframing is politically usable in any specific jurisdiction is an empirical question, not a claim of this paper." },
];
