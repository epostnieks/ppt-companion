// ══════════════════════════════════════════════════════════════
// PST BREAKER — Country × Sector × Actor Level Data
// Erik Postnieks © 2026
// Each entry maps the fastest path from PST → non-PST
// ══════════════════════════════════════════════════════════════
...
export const COUNTRIES = [
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              "Implement carbon border adjustment (CBAM) for fossil fuel imports — EU operational 2026",
      ...
      {
        name: "PFAS / Forever Chemicals", beta: 35.2,
        pst: [true, true, true],
        mostBreakable: 0, // Axiom 1 — Overlapping Interests
        whyBreakable: "Ban PFAS production class-wide. If the profitable pathway does not exist, there is no overlapping interest to exploit. The Montreal Protocol model — eliminate the product, not the externality.",
        breakPaths: [
          "Class-wide production ban eliminates the deal. No PFAS production → no overlapping interest between manufacturer and buyer. The Montreal Protocol proved this works: ban CFCs, the ozone layer recovers. Ban PFAS, the accumulation stops.",
          "CERCLA hazardous substance designation makes contamination costs computable — W becomes a function of production volume. EPA designated PFOA/PFOS in 2024. 14,000+ compounds remain.",
          "Not breakable. The C-F bond (485 kJ/mol) guarantees that PFAS production → PFAS accumulation. No process design can prevent environmental persistence of a molecule designed to persist.",
        ],
        actors: [
          {
            level: "Insider / Whistleblower", role: "insider",
            actions: [
              "Report undisclosed PFAS contamination at manufacturing sites via EPA TSCA §16 whistleblower protection",
              "Document PFAS in consumer products not labeled — report to state AG or FTC",
            ...
            infra: "EPA TSCA §16 (Toxic Substances Control Act, Section 16) — provides whistleblower protection for employees who report violations of chemical safety regulations. Covers workers at PFAS manufacturing facilities, testing laboratories, and disposal sites who report concealed contamination or safety data suppression. DOJ False Claims Act — particularly relevant for PFAS at military installations, where defense contractors used AFFF (aqueous film-forming foam) firefighting chemicals containing PFAS. If contractors knew about contamination and failed to disclose it while billing the federal government, qui tam suits allow whistleblowers to recover 15–30% of damages. SEC Whistleblower Program — applies when publicly traded PFAS manufacturers (3M, Chemours, Corteva) conceal cleanup liabilities from investors. Undisclosed CERCLA liability is a material omission. State Attorneys General — many state AGs have filed PFAS suits (e.g., Minnesota v. 3M, settled for $850M). Insiders can report to their state AG office, which can pursue enforcement even when federal agencies are slow to act.",
          },
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: [
              "Accelerate transition to non-PFAS alternatives — GenX is not the answer, non-fluorinated alternatives are",
              "Disclose total PFAS liability exposure to shareholders (CERCLA strict liability is coming for balance sheets)",
              "Fund remediation proactively — the cost only increases with delay",
            ],
            infra: "CERCLA (Comprehensive Environmental Response, Compensation, and Liability Act, also known as Superfund) — imposes strict, joint, and several liability on parties responsible for hazardous substance contamination. In 2024, EPA designated PFOA and PFOS as CERCLA hazardous substances, meaning any company that manufactured, used, or disposed of these chemicals can be held liable for cleanup costs regardless of when the contamination occurred. This is retroactive strict liability — it cannot be contracted away. SEC Disclosure Obligations — publicly traded companies must disclose material liabilities. With CERCLA designation, PFAS cleanup costs are now material liabilities that must appear in financial statements. Failure to disclose exposes officers and directors to personal liability. Shareholder Derivative Actions — if boards fail to disclose or address known PFAS liabilities, shareholders can sue directors personally for breach of fiduciary duty. The Caremark standard requires boards to implement systems for monitoring known legal compliance risks.",
          },
          {
            level: "Regulator / Agency", role: "regulator",
            actions: [
              "EPA: Extend CERCLA designation beyond PFOA/PFOS to full PFAS class",
              "FDA: Eliminate PFAS from food contact materials (voluntary phase-out is too slow)",
              "DOD: Mandate PFAS-free AFFF alternatives at all military installations",
              "State legislatures: Follow Maine's 2030 class-wide ban model",
            ],
            infra: "EPA PFAS Strategic Roadmap (2021) — the EPA's multi-year plan to address PFAS contamination through research, restriction, and remediation. Key milestones include CERCLA hazardous substance designations, drinking water standards (4 ppt for PFOA, 4 ppt for PFOS), and TSCA reporting rules. CERCLA Authority — allows EPA to compel responsible parties to clean up contaminated sites and to recover costs from manufacturers, users, and disposers of PFAS. The 2024 PFOA/PFOS designation was the first step; class-wide designation would cover all 14,000+ PFAS compounds. FDA Food Contact Rules — the FDA regulates substances that come into contact with food. PFAS have been used in food packaging (grease-resistant coatings) and cookware. The FDA announced a voluntary industry phase-out, but voluntary timelines are slow and non-binding. State Bans — Maine enacted the first class-wide PFAS ban (effective 2030), Minnesota passed comprehensive PFAS legislation in 2023, and California banned PFAS in cosmetics and textiles. These state-level actions create a patchwork that pressures federal action.",
          },
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: [
              "Expand Stockholm Convention listings to full PFAS class — not compound-by-compound",
              "Support EU ECHA restriction proposal (covers ~10,000 PFAS, exemptions 5–12 years)",
              "Establish international PFAS remediation fund — polluter-pays with manufacturer strict liability",
            ],
            infra: "Stockholm Convention on Persistent Organic Pollutants — an international treaty that bans or restricts the production and use of persistent organic pollutants. PFOS was listed in 2009, PFOA in 2019, and PFHxS in 2022. But with 14,000+ PFAS compounds, the compound-by-compound approach is too slow. Class-wide listing is needed. EU ECHA PFAS Restriction Proposal (2023) — the European Chemicals Agency proposed the broadest chemical restriction in regulatory history, covering approximately 10,000 PFAS compounds. If adopted, it would ban PFAS use across the EU with sector-specific exemptions lasting 5–12 years for essential uses where alternatives do not yet exist. Basel Convention — governs transboundary movement of hazardous waste, relevant for preventing PFAS-contaminated waste from being shipped to countries with weaker environmental regulation.",
          },
        ],
      },
      {
        ...
        breakPaths: [
          "Structural separation — marketplace from private-label, social graph from advertising. Eliminates the overlapping interest between data extraction and service provision. EU DMA is a partial Axiom 1 break.",
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Pre-comply with EU DMA obligations globally, not just in EU markets",
            ],
  ...
  },
  {
    ...
    sectors: [
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "UK CBAM (announced 2027 implementation) — carbon border adjustment on imports",
      ...
      {
        name: "Financial Services (LIBOR Legacy)", beta: 5.5,
        pst: [true, true, true],
        mostBreakable: 1, // Axiom 2 — already broken for LIBOR via SONIA
        whyBreakable: "The SONIA transition IS the completed Axiom 2 break. Transaction-based benchmarks make W (benchmark integrity) computable from market activity. The question now is: which other UK financial services remain in PST?",
        breakPaths: [
  ...
  },
  {
    ...
    sectors: [
      ...
      },
      {
        ...
        breakPaths: [
          "EU 2035 ICE ban eliminates the overlapping interest in combustion vehicle production. But the timeline allows 10+ years of continued PST. Germany fought to include e-fuels exemption — partial Axiom 1 weakening.",
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 0, // Axiom 1
        whyBreakable: "Vision 2030 IS the Axiom 1 break — eliminate the economy's dependence on oil revenue. Saudi Arabia is the only petrostate with a publicly stated, funded, and partially implemented plan to break its own PST. The question is speed, not direction.",
        breakPaths: [
  ...
  },
  {
    ...
    summary: "Strong regulatory state with EU framework. Sapin II law (2016) introduced France's first whistleblower protections and created the Agence Française Anticorruption. Nuclear-dominant energy mix (70% of electricity) means France's PST challenges are in agriculture, finance, and industrial chemicals rather than power generation.",
    sectors: [
      {
  ...
  },
  {
    ...
    summary: "Oil sands are Canada's primary PST challenge — the world's third-largest oil reserves with among the highest extraction emissions per barrel. Strong federal whistleblower framework (PSDPA for public sector, provincial laws for private). Carbon pricing via federal backstop. Indigenous rights add a critical dimension to resource extraction PST.",
    sectors: [
      {
  ...
  },
  {
    ...
    summary: "World's largest coal exporter and a major LNG exporter. The Safeguard Mechanism (reformed 2023) is Australia's primary industrial emissions policy. Whistleblower protections strengthened in 2019 (Corporations Act Part 9.4AAA). Great Barrier Reef degradation is the visible face of Australian PST.",
    sectors: [
      {
  ...
  },
  {
    ...
    summary: "World's third-largest emitter with massive coal dependence (70% of electricity) alongside rapid renewable deployment. Whistleblower Protection Act 2014 covers public servants; private sector protection is limited to Companies Act 2013 vigil mechanism. India's PST is driven by the tension between development needs and environmental costs.",
    sectors: [
      {
    ...
    sectors: [
      {
        ...
        breakPaths: [
          "Adopt front-of-pack health-impact labelling (Nutri-Score or equivalent). When consumers can see the welfare cost at point of sale, the overlapping interest between manufacturer and retailer in high-margin UPF weakens — healthier alternatives become competitively viable.",
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Commission independent health-impact assessment of product portfolio using SAPM beta methodology",
            ],
  ...
  // --- Mexico ---
  {
    ...
    summary: "Major oil producer (Pemex) with 2.16% combined oil and gas rents. Strong manufacturing base (19.8% of GDP) driven by USMCA trade integration. Pioneering UPF regulation — Mexico's front-of-pack warning labels and junk food advertising bans are global models.",
    sectors: [
      {
        name: "Oil & Gas", beta: 6.2,
        pst: [true, true, true],
        ...
        breakPaths: [
          ...
          "Implement mandatory emissions disclosure for all oil and gas operations — Pemex's actual emissions footprint is poorly measured. Satellite methane monitoring and TCFD-aligned reporting would make W computable from production data.",
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Implement TCFD-aligned climate disclosure for all operations",
          ...
          },
          {
            ...
            actions: [
              ...
              "CRE: Accelerate renewable energy permitting and grid access for solar and wind projects",
              "CNH: Enforce production efficiency standards and flaring reduction targets",
            ],
            infra: "SEMARNAT (Secretaría de Medio Ambiente y Recursos Naturales) — Mexico's federal environment ministry, responsible for environmental policy, climate change strategy, and natural resource management. SEMARNAT issues environmental impact authorizations (MIA) required for energy projects. CRE (Comisión Reguladora de Energía) — the independent energy regulator that oversees electricity and natural gas markets, sets tariffs, and issues permits for power generation. CRE's role in renewable energy permitting is critical for energy transition. CENACE (Centro Nacional de Control de Energía) — the independent system operator for Mexico's electricity grid, responsible for dispatch and grid access. CENACE's operational decisions affect the competitiveness of renewable vs. fossil generation.",
          },
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: [
  ...
  // --- Spain ---
  {
    ...
    summary: "Services-dominated economy (68.9% of GDP) with growing renewable energy sector. Spain is a European leader in solar and wind deployment but faces PST exposure through intensive agriculture, tourism-driven real estate, and legacy coal regions.",
    sectors: [
      {
        name: "Monoculture Agriculture", beta: 8.6,
        pst: [true, true, true],
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 0,
        whyBreakable: "Norway's petroleum tax regime captures 78% of oil profits for the state. The Government Pension Fund Global (GPFG) has already divested from coal. Extending divestment to oil and gas eliminates the overlapping interest — if the wealth fund won't invest in fossil fuels, the signal cascades through global capital markets.",
        breakPaths: [
          "GPFG full fossil fuel divestment. The world's largest sovereign wealth fund divesting from oil and gas would remove approximately $40B from fossil fuel equity markets and trigger cascading divestment by funds that benchmark against it. The overlapping interest between capital allocators and fossil producers breaks when the benchmark excludes them.",
        ...
        actors: [
          {
            ...
            actions: [
              ...
              "Report concerns about GPFG investment decisions to Norges Bank Investment Management ethics council",
            ],
          ...
          },
          {
            ...
            infra: "Miljødirektoratet (Norwegian Environment Agency) — the executive agency under the Ministry of Climate and Environment, responsible for environmental monitoring, regulation, and enforcement. Issues emissions permits for industrial activities including offshore petroleum. Finanstilsynet (Financial Supervisory Authority of Norway) — supervises banks, insurance companies, and securities markets. Oversees climate-related financial disclosure requirements. NBIM (Norges Bank Investment Management) — manages the GPFG, the world's largest sovereign wealth fund ($1.7T+). NBIM's investment decisions, ethical exclusions, and voting guidelines influence corporate governance globally. The fund owns approximately 1.5% of all listed equities worldwide.",
          },
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: [
              "Contact your representative in the Storting to demand a timeline for ending new oil and gas exploration licenses",
              "Expand GPFG fossil fuel exclusion criteria from coal-only to include oil and gas companies without Paris-aligned transition plans",
  ...
  // --- Switzerland ---
  {
    ...
    summary: "Global commodity trading hub — over 50% of world oil and 35% of metals are traded through Swiss firms (Glencore, Vitol, Trafigura, Gunvor). Financial center with $7.6T in managed assets. Low domestic resource extraction but enormous intermediation-based PST exposure.",
    sectors: [
      {
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Adopt TCFD reporting voluntarily — Swiss mandatory climate reporting is coming",
            ],
            infra: "Swiss Due Diligence Act (effective January 2023) — requires large Swiss companies to conduct due diligence on child labor and conflict minerals in their supply chains and report publicly. This is the indirect counterproposal to the Responsible Business Initiative that narrowly failed in November 2020. TCFD and ISSB Standards — Switzerland has signaled intent to adopt ISSB sustainability reporting standards. FINMA has issued climate disclosure guidance for banks and insurers, but commodity trading firms are not yet covered.",
          },
          {
            level: "Regulator / Agency", role: "regulator",
            actions: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Advocate for Switzerland to align its climate policies with EU CBAM and CSRD standards",
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "UAE's mandatory ESG disclosure framework (Abu Dhabi Securities Exchange, 2023) and hosting of COP28 signal willingness to make emissions data visible. Once per-field emissions are disclosed alongside revenue, W becomes computable from production data.",
        breakPaths: [
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Implement TCFD-aligned climate disclosure for all operations and subsidiaries",
          ...
          },
          {
            ...
            infra: "SCA (Securities and Commodities Authority) — the UAE's federal securities regulator, overseeing the Abu Dhabi Securities Exchange (ADX) and Dubai Financial Market (DFM). SCA has introduced ESG disclosure requirements for listed companies. EAD (Environment Agency Abu Dhabi) — the environmental regulator for Abu Dhabi emirate, responsible for environmental permitting and monitoring of industrial facilities including ADNOC operations.",
          },
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: [
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Adopt TCFD-aligned climate disclosure for all production sharing agreements",
            ],
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "Implement TCFD-aligned climate disclosure across all operations",
  ...
  // --- Austria ---
  {
    ...
    summary: "Wealthy EU economy ($534.8B GDP) with strong manufacturing (15.1% of GDP). Low direct fossil fuel exposure but significant UPF and financial sector PST. Major transit hub for Russian gas (Baumgarten hub). High healthcare expenditure (11.83% GDP) suggests diet-related disease burden.",
    sectors: [
      {
        name: "Ultra-Processed Food", beta: 6.2,
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "Austria's healthcare system (ASVG social insurance) tracks diet-related disease costs with high granularity. When per-product-category healthcare costs are published alongside retail revenue, W becomes computable from bilateral UPF transactions.",
        breakPaths: [
          "Implement front-of-pack health-impact labelling through EU Farm to Fork Strategy. When consumers see welfare costs at point of sale, the overlapping interest between UPF manufacturers and retailers in high-margin processed products weakens.",
        ...
        actors: [
          ...
          },
          {
            level: "Regulator / Agency", role: "regulator",
            actions: [
              "BMSGPK: Implement mandatory front-of-pack health labelling for UPF products",
          ...
          },
          {
            ...
            actions: [
              ...
              "Push for WHO-aligned UPF marketing restrictions through EU legislative process",
            ],
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "SOFAZ: Adopt ESG investment criteria excluding new fossil fuel development",
            ],
    ...
    sectors: [
      {
        ...
        breakPaths: [
          "Implement front-of-pack health labelling (Belgium adopted Nutri-Score voluntarily in 2019). Extending to mandatory application and adding health-cost information weakens the overlapping interest in high-margin UPF.",
        ...
        actors: [
          ...
          },
          {
            ...
            actions: [
              ...
              "AFSCA/FAVV: Strengthen enforcement of marketing claims on UPF products",
          ...
          },
          {
            ...
            actions: [
              ...
              "Advocate for WHO-aligned UPF marketing restrictions",
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          },
          {
            ...
            infra: "Major mining companies operating in Burkina Faso include Endeavour Mining (Houndé, Wahgnion mines), IAMGOLD (Essakane mine), and Nordgold (Bissa-Bouly). These international companies are subject to home-country ESG reporting requirements and international mining standards (ICMM, IFC Performance Standards).",
          },
          {
            level: "Regulator / Agency", role: "regulator",
            actions: [
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          },
          {
            ...
            infra: "NOGA (National Oil and Gas Authority) — the government body responsible for oil and gas policy, licensing, and upstream regulation. CBB (Central Bank of Bahrain) — the financial sector regulator, which has begun integrating ESG considerations into banking supervision. Bahrain Economic Development Board — coordinates the Economic Vision 2030 diversification strategy.",
          },
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: [
              ...
              "Push for enhanced climate disclosure standards through the Bahrain Bourse ESG framework",
    ...
    sectors: [
      {
        ...
        breakPaths: [
          ...
          "Implement per-field emissions disclosure for all BSP and Total operations. Shell's global ESG reporting standards can be extended to Brunei operations to make W computable.",
          "Not breakable by policy alone. Hydrocarbon combustion releases CO₂ by conservation of mass.",
        ],
        actors: [
          {
          ...
          },
          {
            ...
            actions: [
              ...
              "Implement TCFD-aligned climate disclosure for all Brunei operations",
            ],
    ...
    sectors: [
      {
        ...
        breakPaths: [
          "Implement full beneficial ownership transparency in line with FATF recommendations. When the competitive advantage of Bahamian financial secrecy is eliminated through transparency, the overlapping interest between offshore service providers and tax-avoiding clients weakens.",
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "DRC's cobalt is essential for EV batteries — downstream manufacturers (Tesla, Samsung SDI, CATL) face increasing ESG pressure. When supply chain traceability makes mine-level environmental and labor conditions visible to end consumers, W becomes computable from cobalt prices.",
        breakPaths: [
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Perenco, Addax/Sinopec: Implement environmental monitoring and emissions reporting for all Cameroon operations", "SNH: Develop post-oil diversification strategy", "Adopt TCFD-aligned climate disclosure"],
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Ecopetrol: Accelerate energy transition strategy with binding renewable targets", "Implement TCFD-aligned reporting across all operations", "Invest in renewable energy in post-conflict zones to provide economic alternatives"],
  ...
  // --- Costa Rica ---
  {
    ...
    summary: "Upper-middle-income economy ($95.4B GDP) with 98%+ renewable electricity generation. No military since 1948. Services-dominant (68.8% GDP). Leader in ecotourism and environmental policy. Low direct fossil fuel extraction. Main PST exposure through agricultural monoculture (pineapple, banana, palm oil).",
    sectors: [
      {
        name: "Monoculture Agriculture", beta: 8.6,
        pst: [true, true, true],
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Implement enhanced due diligence for all high-risk client relationships", "Adopt full beneficial ownership transparency ahead of EU AMLD6 requirements", "Integrate ESG criteria into financial advisory services"],
          ...
          {
            level: "Supranational Body / Treaty", role: "supranational",
            actions: ["Contact your Βουλευτής in the Βουλή των Αντιπροσώπων (House of Representatives) to demand full implementation of EU AML directives", "Support EU AMLD6 negotiations for enhanced transparency requirements", "Advocate for OECD BEPS Inclusive Framework strengthening", "Push for EU-wide beneficial ownership registry interconnection"],
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["PetroEcuador: Develop transition plan to phase out operations in ecologically sensitive areas", "Implement TCFD-aligned disclosure", "Invest in remediation of legacy contamination (Lago Agrio)"],
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Eni (Zohr operator): Implement emissions reduction targets for Egyptian operations", "EGPC: Develop renewable energy investment division", "Adopt TCFD-aligned climate disclosure"],
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "Guinea's bauxite mining displaces communities and contaminates water sources. As aluminum buyers face ESG pressure (EU CSRD, Apple/Tesla supply chain requirements), making per-mine environmental data visible breaks system independence.",
        breakPaths: [
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["ExxonMobil, Marathon Oil: Apply global environmental standards to EG operations", "Report Scope 1-3 emissions for EG operations in global ESG disclosures", "Implement community development programs"],
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "Greece's Mediterranean diet is being displaced by UPF consumption, contributing to rising obesity (Greece has one of Europe's highest childhood obesity rates). When diet-related healthcare costs are published per product category through EOPYY health insurance data, W becomes computable.",
        breakPaths: [
          "Implement front-of-pack health labelling to make welfare costs visible to consumers. When UPF health costs are visible at point of sale, the overlapping interest between processors and retailers in high-margin UPF weakens.",
        ...
        actors: [
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Greek food companies: Invest in traditional Mediterranean diet products over UPF", "Adopt voluntary front-of-pack labelling", "Commission health-impact assessments"],
            infra: "SEVT (Σύνδεσμος Ελληνικών Βιομηχανιών Τροφίμων / Federation of Hellenic Food Industries) — the food industry trade association. Greece's traditional food sector (olive oil, dairy, honey) provides a competitive alternative to UPF.",
          },
          {
            level: "Regulator / Agency", role: "regulator",
    ...
    sectors: [
      {
        ...
        breakPaths: [
          ...
          "Partially breakable. Palm oil monoculture reduces biodiversity. However, agroforestry integration and RSPO certification can reduce system dependence.",
        ],
        actors: [
          {
            level: "Insider / Whistleblower", role: "insider",
          ...
          {
            level: "Investor / Capital Allocator", role: "investor",
            actions: ["Palm oil companies (REPSA, NaturAceites): Adopt RSPO certification and zero-deforestation commitments", "International buyers: Require supply chain traceability for Guatemalan palm oil", "Invest in community benefit-sharing agreements"],
  ...
  // --- Guyana ---
  {
    ...
    summary: "Fastest-growing economy globally ($24.7B GDP, up from $5.5B in 2019) due to massive offshore oil discoveries (Stabroek block). Oil rents at 22.08%, mining at 9.38% (gold, bauxite). Small population (800K). At risk of 'resource curse' — extraordinary PST exposure from rapid petro-development.",
    sectors: [
      {
        name: "Oil & Gas", beta: 6.2,
        pst: [true, true, true],
    ...
    sectors: [
      {
        ...
        breakPaths: [
          "Mandatory financed emissions disclosure for all HKEX-listed financial institutions. When banks must disclose the emissions their lending supports, the overlapping interest in fossil fuel financing weakens — ESG-aware investors reallocate.",
        ...
        actors: [
          { level: "Insider / Whistleblower", role: "insider", actions: ["Report greenwashing to SFC (Securities and Futures Commission)", "Document ESG disclosure violations — report to HKEX listing division", "Report through internal bank compliance channels"], infra: "SFC (Securities and Futures Commission) — regulates securities, futures markets, and listed companies. HKEX (Hong Kong Exchanges and Clearing) — operates the stock exchange and sets listing rules including ESG disclosure requirements. HKMA (Hong Kong Monetary Authority) — the de facto central bank. Note: Under the National Security Law (2020), civil liberties are constrained." },
          { level: "Investor / Capital Allocator", role: "investor", actions: ["Adopt TCFD-aligned disclosure across all operations", "Set financed emissions reduction targets", "Integrate climate risk into lending decisions"], infra: "Major banks in Hong Kong: HSBC, Standard Chartered, Bank of China (Hong Kong), Hang Seng Bank. Green and Sustainable Finance Cross-Agency Steering Group — coordinates climate finance policy across HKMA, SFC, and other regulators." },
          { level: "Regulator / Agency", role: "regulator", actions: ["HKMA: Mandate climate stress testing for all authorized institutions", "SFC: Enforce enhanced ESG disclosure for listed companies", "HKEX: Strengthen climate-related listing requirements"], infra: "HKMA — supervises 160+ licensed banks. The HKMA's Climate Risk Management Supervisory Policy Manual (2021) sets expectations for banks' climate risk management." },
          { level: "Supranational Body / Treaty", role: "supranational", actions: ["Advocate through IOSCO for global securities regulator coordination on climate disclosure", "Support ISSB sustainability reporting standards adoption in Hong Kong", "Push for Network for Greening the Financial System (NGFS) recommendations implementation", "Leverage Hong Kong's role as a Belt and Road financing hub to require climate standards"], infra: "Note: Hong Kong's Legislative Council (90 members) is not freely elected under the 2021 electoral reform. International engagement operates through financial regulatory cooperation (IOSCO, BIS, NGFS) and Hong Kong's role as an international financial center." },
        ],
      },
    ],
  },
    ...
    sectors: [
      {
        ...
        breakPaths: [
          ...
          "Partially breakable. Palm oil monoculture inherently reduces biodiversity. RSPO certification and agroforestry can reduce system dependence.",
        ],
        actors: [
          { level: "Insider / Whistleblower", role: "insider", actions: ["Report illegal deforestation to ICF (Instituto de Conservación Forestal)", "Document land rights violations — report to CONADEH (Comisionado Nacional de los Derechos Humanos)", "Report through RSPO complaint mechanisms"], infra: "ICF (Instituto de Conservación Forestal) — responsible for forest management and conservation. CONADEH — the national human rights commissioner. Note: Honduras is one of the most dangerous countries for environmental defenders — Global Witness documents multiple killings annually." },
          { level: "Investor / Capital Allocator", role: "investor", actions: ["Palm oil companies (Dinant, Jaremar): Adopt RSPO certification and zero-deforestation commitments", "Implement community benefit-sharing agreements", "International buyers: Require traceability"], infra: "Corporación Dinant — Honduras's largest palm oil producer (implicated in Aguán Valley land conflicts). Jaremar — another major palm oil company. IFC (International Finance Corporation) — has faced accountability complaints regarding investments in Honduran palm oil." },
    ...
    sectors: [
      {
        ...
        pst: [true, true, true],
        mostBreakable: 1,
        whyBreakable: "Hungary has one of Europe's highest obesity rates and introduced a 'chip tax' (NETA — népegészségügyi termékadó) on UPF in 2011. When health insurance data (NEAK) links diet to healthcare costs per product category, W becomes computable.",
        breakPaths: ["Strengthen the NETA tax and extend to broader UPF categories. Hungary's pioneering public health product tax weakens the overlapping interest in high-margin UPF by internalizing health costs.", "NEAK publication of diet-attributable healthcare expenditure. Hungary's health insurance system generates data to make W computable.", "Not fully breakable. Ultra-processing alters food matrix. Reformulation targets can reduce system dependence."],
        actors: [
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          { level: "Investor / Capital Allocator", role: "investor", actions: ["Wilmar, Golden Agri-Resources, Sinar Mas: Implement full NDPE (No Deforestation, No Peat, No Exploitation) commitments", "Adopt RSPO certification across all operations", "Invest in yield improvement rather than area expansion"], infra: "Wilmar International — the world's largest palm oil trader. Golden Agri-Resources (Sinar Mas Group) — one of the largest palm oil producers. GAPKI (Gabungan Pengusaha Kelapa Sawit Indonesia) — the Indonesian palm oil association. RSPO and ISPO (Indonesian Sustainable Palm Oil) — certification standards." },
    ...
    sectors: [
      {
        ...
        actors: [
          { level: "Insider / Whistleblower", role: "insider", actions: ["Report environmental violations to the Ministry of Environmental Protection", "Document offshore emissions — report through Delek/Chevron compliance channels", "Report to ISA if ESG disclosures are misleading"], infra: "Ministry of Environmental Protection — Israel's environmental authority. ISA (Israel Securities Authority) — regulates disclosure for listed companies including Delek Group. Israel has whistleblower protections under the Protection of Workers (Exposure of Offenses) Law, 1997." },
          { level: "Investor / Capital Allocator", role: "investor", actions: ["NewMed Energy (formerly Delek Drilling), Chevron: Set emissions reduction targets for Leviathan and Tamar", "Invest in regional renewable energy integration", "Adopt TCFD-aligned disclosure"], infra: "NewMed Energy — operates Leviathan field. Chevron — acquired Noble Energy's interest in Tamar. Israel Natural Gas Lines (INGL) — the state-owned gas transmission company." },
  ...
  // --- Iceland ---
  {
    ...
    summary: "Small advanced economy ($33.3B GDP) with 100% renewable electricity (geothermal and hydro). Fisheries are 5% of GDP and the largest PST exposure — Iceland's fisheries management is globally studied but faces sustainability challenges from ocean warming.",
    sectors: [
      {
    ...
    sectors: [
      {
        ...
        actors: [
          ...
          { level: "Investor / Capital Allocator", role: "investor", actions: ["Implement enhanced beneficial ownership due diligence", "Adopt ESG integration across fund and trust structures", "Align with UK transparency standards ahead of regulatory mandates"], infra: "Channel Islands host operations of major international banks and fund administrators. Jersey Finance and Guernsey Finance promote the financial services sectors." },
  ...
  { code: "KW", name: "Kuwait", region: "Middle East", summary: "Wealthy petrostate ($160.2B GDP) with 29.28% combined oil and gas rents. Kuwait Petroleum Corporation (KPC) manages all oil operations. Kuwait Investment Authority (KIA) is one of the world's oldest sovereign wealth funds. Constitutional monarchy with elected parliament.", sectors: [{ name: "Oil & Gas", beta: 6.2, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Kuwait's Burgan oil field (world's second-largest) is mature. As production costs rise, the overlapping interest weakens. KIA sovereign wealth provides a diversification mechanism.", breakPaths: ["KIA investment diversification away from fossil fuels. When the sovereign wealth fund's returns from non-oil investments exceed declining oil returns, the overlapping interest in oil dependence breaks.", "Per-field emissions disclosure for KPC operations. Making environmental costs visible makes W computable.", "Not breakable. Hydrocarbon combustion releases CO₂."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["KPC: Develop renewable energy division", "KIA: Adopt ESG investment criteria", "Implement emissions reduction targets"], infra: "KPC — manages Kuwait's entire petroleum value chain. KIA (Kuwait Investment Authority) — sovereign wealth fund, one of the world's largest." },
  ...
  // --- Lebanon ---
  { code: "LB", name: "Lebanon", region: "Middle East", summary: "Collapsed economy ($20.1B GDP, down from $55B in 2018). Banking sector crisis wiped out savings. Services historically dominated. Political system based on sectarian power-sharing (confessionalism). Multiple concurrent crises — economic, political, refugee.", sectors: [{ name: "Financial Services", beta: 4.2, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Lebanon's banking sector collapse (2019-present) represents a PST endgame — the overlapping interest has already partially broken through crisis. The remaining PST is in the lack of accountability for banking sector losses.", breakPaths: ["Banking sector restructuring with full forensic audit of capital outflows. When accountability is established for the $72B+ in depositor losses, the overlapping interest between banks, politicians, and central bank in opacity breaks.", "Publication of forensic audit results (Alvarez & Marsal was contracted but access was blocked). Making the flow of funds visible makes W computable.", "Partially breakable — the crisis has already revealed system dependence. But without institutional reform, the same dynamics can rebuild."], actors: [
  ...
  { code: "LT", name: "Lithuania", region: "Europe", summary: "Baltic EU and Eurozone member ($84.9B GDP). Services at 63.6% GDP. Manufacturing at 14% GDP. Achieved energy independence from Russian gas (Klaipėda LNG terminal). Agriculture at 2.6% GDP.", sectors: [{ name: "Ultra-Processed Food", beta: 6.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Lithuania's health insurance system (VLK) tracks healthcare costs. Publishing diet-attributable disease costs makes W computable.", breakPaths: ["EU front-of-pack health labelling implementation.", "VLK publication of diet-related healthcare data.", "Not fully breakable. Reformulation can reduce system dependence."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["Lithuanian food companies: Reformulate UPF products", "Adopt voluntary front-of-pack labelling"], infra: "Major companies: Vilniaus Pienine, Rokiškio Sūris (dairy)." },
  ...
  { code: "LU", name: "Luxembourg", region: "Europe", summary: "Major EU financial center ($93.3B GDP, highest GDP per capita globally). Services at 81.2% GDP. World's second-largest investment fund domicile (after US). EU institutions host. Steel industry legacy (ArcelorMittal).", sectors: [{ name: "Financial Services", beta: 4.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Luxembourg's investment fund industry manages €5T+ in assets. When financed emissions and beneficial ownership are disclosed, W becomes computable from financial intermediation data.", breakPaths: ["Full EU SFDR and AMLD implementation. When fund-level financed emissions and beneficial ownership are transparent, the overlapping interest in opaque financial intermediation weakens.", "CSSF mandatory ESG disclosure for all Luxembourg-domiciled funds. Making climate impact visible per fund makes W computable.", "Partially breakable. Fund domiciliation can relocate, but Luxembourg's legal infrastructure and EU access create switching costs."], actors: [
    ...
    { level: "Regulator / Agency", role: "regulator", actions: ["CSSF: Strengthen ESG disclosure enforcement", "BCL (Central Bank): Integrate climate risk into financial stability monitoring", "Implement EU Green Taxonomy alignment requirements"], infra: "CSSF — conducts supervision of the fund industry. BCL (Banque centrale du Luxembourg) — participates in ECB monetary policy and macroprudential supervision." },
    { level: "Supranational Body / Treaty", role: "supranational", actions: ["Contact your Député in the Chambre des Députés to demand enhanced financial transparency", "Support EU-wide beneficial ownership registry interconnection", "Advocate for OECD BEPS enforcement", "Push for Luxembourg Green Bond Framework expansion"], infra: "Chambre des Députés — unicameral parliament, 60 members. Contact through chd.lu. Luxembourg was instrumental in establishing the EU Green Bond Standard and hosts the Luxembourg Green Exchange." }
  ]}] },
  // --- Latvia ---
  ...
  { code: "LY", name: "Libya", region: "North Africa", summary: "Oil-dependent fragile state ($48.5B GDP) with 60.96% combined oil and gas rents — one of the world's highest. NOC (National Oil Corporation) manages production (~1.2M bpd when not disrupted). Divided governance (Tripoli vs. eastern-based authorities). Ongoing instability since 2011.", sectors: [{ name: "Oil & Gas", beta: 6.2, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Libya's oil production is repeatedly disrupted by factional conflict (fields and export terminals seized as bargaining chips). The overlapping interest is already partially broken by instability — production is not reliably monetizable.", breakPaths: ["Governance reform that depoliticizes oil revenue distribution. When oil revenue is managed through transparent, rules-based mechanisms (rather than factional control), the overlapping interest in capturing oil infrastructure weakens.", "NOC per-field production and revenue data disclosure. The Libyan Audit Bureau provides some oversight — extending to environmental data makes W computable.", "Not breakable. Hydrocarbon combustion releases CO₂."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["NOC: Maintain operational independence from factional politics", "International partners (Eni, TotalEnergies, Repsol): Apply global ESG standards to Libyan operations", "Implement emissions monitoring"], infra: "NOC — the national oil company operating most production. Eni, TotalEnergies, Repsol, ConocoPhillips — major international operators." },
  ...
  { code: "MC", name: "Monaco", region: "Europe", summary: "City-state ($11.1B GDP) with 87.2% services. Major financial center and tourism hub. No income tax for individuals. World's highest GDP per capita and population density. Limited PST exposure except through financial intermediation.", sectors: [{ name: "Financial Services", beta: 4.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Monaco's financial services facilitate wealth management with favorable tax treatment. When beneficial ownership and tax transparency data are published, W becomes computable.", breakPaths: ["Full compliance with OECD Global Forum transparency standards and CRS information exchange. When opacity is eliminated, the overlapping interest weakens.", "Publication of aggregate beneficial ownership and capital flow data. Makes W computable.", "Partially breakable. Financial services can relocate but Monaco's brand and geographic advantages create switching costs."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["Banks: Implement enhanced CRS compliance", "Adopt full beneficial ownership transparency", "Integrate ESG into wealth management"], infra: "Monaco hosts branches of major international banks. Association Monégasque des Activités Financières (AMAF) — the financial industry association." },
  ...
  { code: "MN", name: "Mongolia", region: "East Asia", summary: "Resource-dependent landlocked economy ($23.8B GDP). Mining at 26.57% GDP (copper, coal, gold). Coal at 4.89% GDP. Oyu Tolgoi copper-gold mine (Rio Tinto/Turquoise Hill). Parliamentary democracy — rare in the region.", sectors: [{ name: "Mining", beta: 4.7, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Mongolia's mining sector (particularly coal and copper) generates dust pollution and depletes water in the Gobi. When per-mine environmental data is linked to production revenue, W becomes computable.", breakPaths: ["Environmental bonds and water-use fees reflecting true scarcity. When mining companies pay for water in arid steppe, the overlapping interest in water-intensive extraction weakens.", "Per-mine environmental monitoring data published through EITI Mongolia. Makes W computable.", "Partially breakable. Mining in arid environments inherently affects limited water resources. However, dry processing and water recycling can reduce dependence."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["Oyu Tolgoi (Rio Tinto): Implement water recycling and environmental monitoring", "Erdenes Mongol (state mining company): Adopt ESG standards", "Coal miners (Energy Resources, Aspire Mining): Develop transition plans"], infra: "Oyu Tolgoi — the giant copper-gold mine (Rio Tinto 66%, Government 34%). Erdenes Mongol — state mining holding company. Tavan Tolgoi — massive coal deposit." },
  ...
  { code: "MU", name: "Mauritius", region: "Sub-Saharan Africa", summary: "Upper-middle-income island economy ($14.9B GDP). Services at 64.4% (financial services, tourism). Manufacturing at 11.1% (textiles). Successful economic diversification from sugar to services. Strong institutions.", sectors: [{ name: "Financial Services", beta: 4.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Mauritius is a major offshore financial center, particularly for India-bound investment (India-Mauritius tax treaty). When beneficial ownership and tax data is transparent, W becomes computable.", breakPaths: ["Full CRS and FATF compliance. When financial opacity is eliminated, the overlapping interest weakens.", "Publication of beneficial ownership data. Makes W computable.", "Partially breakable. Financial services can relocate but Mauritius's India tax treaty and infrastructure create switching costs."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["Banks and management companies: Implement enhanced due diligence", "Adopt ESG criteria in Global Business operations", "Comply with FATF recommendations ahead of mandates"], infra: "Mauritius hosts ~900 Global Business companies (Category 1 and 2). Major banks: SBM Holdings, MCB Group." },
    { level: "Regulator / Agency", role: "regulator", actions: ["FSC: Strengthen Global Business licensing", "Bank of Mauritius: Enhance AML supervision", "EDB (Economic Development Board): Promote substance requirements"], infra: "FSC — regulates the Global Business sector. Bank of Mauritius — the central bank. Mauritius was on the FATF grey list (2020-2021) and implemented reforms." },
    { level: "Supranational Body / Treaty", role: "supranational", actions: ["Contact your member of the National Assembly (70 members) to demand enhanced financial transparency", "Support OECD BEPS Inclusive Framework", "Maintain FATF compliance", "Advocate for African financial transparency standards"], infra: "National Assembly of Mauritius — 70 members. Mauritius is a parliamentary democracy with strong democratic traditions since independence (1968)." }
  ]}] },
  { code: "MW", name: "Malawi", region: "Sub-Saharan Africa", summary: "Low-income economy ($11.3B GDP). Agriculture at 31.8% GDP — tobacco is the largest export (50%+ of export revenue). One of the world's poorest countries. High climate vulnerability.", sectors: [{ name: "Monoculture Agriculture", beta: 8.6, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Malawi's tobacco dependence is an economic PST — tobacco demand is declining globally while the crop depletes soil. As WHO FCTC reduces demand, the overlapping interest between tobacco growers and buyers weakens.", breakPaths: ["Crop diversification as global tobacco demand declines. When alternative crops (legumes, macadamia, soy) provide comparable income, the overlapping interest in tobacco monoculture breaks.", "Publication of soil degradation and health cost data alongside tobacco revenue. Makes W computable.", "Tobacco cultivation depletes soil nutrients and requires heavy pesticide use. Crop rotation can reduce system dependence."], actors: [
  ...
  { code: "MY", name: "Malaysia", region: "Southeast Asia", summary: "Upper-middle-income economy ($422.2B GDP). World's second-largest palm oil producer. Oil and gas at 5.2% rents (Petronas). Manufacturing at 22.5% GDP (electronics, automotive). Services at 53.7%.", sectors: [{ name: "Palm Oil", beta: 6.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Malaysia produces ~25% of global palm oil. EUDR and MSPO certification create traceability frameworks. When per-plantation environmental data is linked to trade, W becomes computable.", breakPaths: ["EUDR compliance requiring zero-deforestation traceability. When buyers verify origin, the overlapping interest in forest conversion for plantations breaks.", "Mandatory MSPO (Malaysian Sustainable Palm Oil) certification with independently verifiable environmental data per estate. Makes W computable.", "Partially breakable. Palm oil monoculture reduces biodiversity. But yield improvement on existing plantations can reduce expansion pressure."], actors: [
    ...
    { level: "Supranational Body / Treaty", role: "supranational", actions: ["Contact your Ahli Parlimen in the Dewan Rakyat (222 members) to demand peatland protection enforcement", "Support EUDR implementation with transition assistance for smallholders", "Advocate through ASEAN for regional zero-deforestation commitments", "Push for RSPO-MSPO mutual recognition with enhanced environmental standards"], infra: "Parliament of Malaysia — bicameral: Dewan Rakyat (222 members) and Dewan Negara (70 members). Contact through parlimen.gov.my. Malaysia is a federal constitutional monarchy and parliamentary democracy." }
  ]}] },
  ...
  { code: "OM", name: "Oman", region: "Middle East", summary: "Oil-dependent Gulf economy ($107.1B GDP) with 29.21% combined oil and gas rents. PDO (Petroleum Development Oman, 60% government, 34% Shell) is the main operator. Diversifying through Oman Vision 2040. Hydrogen ambitions.", sectors: [{ name: "Oil & Gas", beta: 6.2, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Oman's oil production uses enhanced oil recovery (EOR) including solar-powered steam injection. As EOR costs rise on mature fields, diversification to green hydrogen becomes economically rational.", breakPaths: ["Green hydrogen investment as alternative export commodity. Oman has committed $30B+ to green hydrogen projects. When hydrogen revenue streams are established, the overlapping interest in oil dependence weakens.", "Per-field emissions disclosure for all PDO and other operator operations. Makes W computable.", "Not breakable. Hydrocarbon combustion releases CO₂."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["PDO: Accelerate renewable energy integration in operations", "OQ (state energy company): Develop green hydrogen export capacity", "Implement TCFD reporting"], infra: "PDO — produces ~70% of Oman's oil. OQ (formerly Oman Oil Company) — the state energy holding company. Hydrom — the government entity driving Oman's green hydrogen ambitions." },
  ...
  { code: "SG", name: "Singapore", region: "Southeast Asia", summary: "Advanced city-state economy ($547.4B GDP). Services at 73% GDP. Manufacturing at 16.3% (electronics, petrochemicals). No natural resources. Major petrochemical refining hub and global financial center. World's busiest transshipment port.", sectors: [{ name: "Oil & Gas", beta: 6.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Singapore is a major petrochemical refining and trading hub — the 'Houston of Asia.' When refinery emissions and fossil fuel trading flows are disclosed per facility, W becomes computable.", breakPaths: ["Carbon tax escalation (Singapore's carbon tax rises to S$25/tCO₂ in 2024, S$45 in 2026, S$50-80 by 2030). When refining margins incorporate carbon costs, the overlapping interest in unpriced emissions weakens.", "Per-refinery emissions and trade-flow disclosure. MAS (Monetary Authority of Singapore) climate disclosure requirements extend to financial flows. Makes W computable.", "Partially breakable. Petrochemical refining inherently emits. However, Singapore's investment in sustainable aviation fuel and green hydrogen can reduce system dependence over time."], actors: [
    ...
    { level: "Regulator / Agency", role: "regulator", actions: ["NEA: Accelerate carbon tax escalation timeline", "MAS: Strengthen climate-related financial disclosure (TCFD alignment)", "EMA (Energy Market Authority): Mandate renewable energy targets"], infra: "EMA (Energy Market Authority) — energy regulator. Singapore Green Plan 2030 — national sustainability framework. Carbon tax administered by NEA under Carbon Pricing Act." },
  ...
  { code: "SK", name: "Slovak Republic", region: "Europe", summary: "Central European EU member ($140.9B GDP). Manufacturing at 16.3% GDP — heavily auto-dependent (Volkswagen, Kia, Stellantis). Services at 60%. EU member since 2004. World's largest per-capita car producer.", sectors: [{ name: "UPF", beta: 6.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Slovakia's food processing industry produces significant ultra-processed food for regional markets. When per-product health impact data (obesity, diabetes correlations) is disclosed alongside marketing spend, W becomes computable.", breakPaths: ["EU front-of-pack labeling (Nutri-Score or equivalent). When consumers can identify ultra-processing, the overlapping interest in opaque ingredient lists weakens.", "Mandatory per-product health impact disclosure. Slovakia has rising obesity rates (20%+). Linking UPF consumption data to health outcomes makes W computable.", "Not breakable. Ultra-processing by definition strips nutritional value and adds synthetic additives."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["Food processors: Reformulate to reduce ultra-processing", "Retailers (Lidl, Kaufland, Tesco): Adopt front-of-pack labeling", "Advertisers: Restrict UPF marketing to children"], infra: "Slovakia's food retail is dominated by international chains (Lidl, Kaufland, Tesco, Billa). Slovenská poľnohospodárska a potravinárska komora — food industry chamber." },
  ...
  { code: "TH", name: "Thailand", region: "Southeast Asia", summary: "Major Southeast Asian economy ($526.5B GDP). Manufacturing at 24.3% GDP (automotive, electronics, food processing). Agriculture at 8.7%. Services at 59.2%. World's largest rice exporter. Significant petrochemical sector. Constitutional monarchy.", sectors: [{ name: "UPF", beta: 6.2, pst: [true, true, true], mostBreakable: 1, whyBreakable: "Thailand is a major UPF producer and exporter (CP Group — Charoen Pokphand — is one of Asia's largest food conglomerates). When per-product health impact data is linked to marketing and formulation, W becomes computable.", breakPaths: ["Front-of-pack labeling reform. Thailand's existing traffic-light label (GDA) covers some nutrients — extending to ultra-processing indicators weakens the overlapping interest in opaque formulation.", "Per-product health outcome correlation data. Thailand's rising obesity and diabetes rates can be linked to UPF consumption patterns. Makes W computable.", "Not breakable. Ultra-processing by definition strips nutritional value."], actors: [
    ...
    { level: "Regulator / Agency", role: "regulator", actions: ["Thai FDA: Extend labeling to cover ultra-processing indicators", "Ministry of Public Health: Strengthen sugar tax and UPF marketing restrictions", "ThaiHealth: Fund UPF health impact research"], infra: "Ministry of Public Health — health policy. Thai FDA — food regulation. Thailand's sugar tax (2017) is one of the region's most progressive." },
    { level: "Supranational Body / Treaty", role: "supranational", actions: ["Contact your สมาชิกสภาผู้แทนราษฎร (Member of the House of Representatives, 500 members) to demand UPF labeling reform", "Support ASEAN food labeling harmonization", "Advocate through WHO SEARO for ultra-processed food regulation", "Push for Codex Alimentarius UPF classification standards"], infra: "รัฐสภา (National Assembly) — bicameral: สภาผู้แทนราษฎร (House of Representatives, 500 members) and วุฒิสภา (Senate, 200 members). Thailand is a constitutional monarchy. Recent democratic restoration (2023 elections)." }
  ]}] },
  ...
  { code: "VE", name: "Venezuela", region: "South America", summary: "Oil-dependent economy in crisis ($119.8B GDP — severely contracted from peak). World's largest proven oil reserves. Economic data largely unavailable (World Bank reports zeros for most indicators). Hyperinflation, mass emigration. Authoritarian governance.", sectors: [{ name: "Oil & Gas", beta: 6.2, pst: [true, true, true], mostBreakable: 0, whyBreakable: "Venezuela's oil industry has collapsed from ~3.3M bpd (1990s) to ~700K bpd due to mismanagement, underinvestment, and sanctions. The overlapping interest is already weakened by operational failure.", breakPaths: ["Production collapse has already weakened the overlapping interest — PDVSA lacks the capital and technical capacity to maintain production. Sanctions further constrain revenue.", "Oil revenue transparency is impossible under current governance opacity. However, international sanctions monitoring (OFAC designations) provides partial W computability.", "Not breakable. Oil extraction and refining emit CO₂. Venezuela's heavy crude (Orinoco Belt) is particularly emissions-intensive to process."], actors: [
    ...
    { level: "Investor / Capital Allocator", role: "investor", actions: ["International oil companies with remaining interests (Chevron, Repsol, ENI): Apply environmental standards to limited operations", "Chevron: Publish per-facility environmental data for Venezuela operations", "Service companies: Maintain environmental standards in contracted work"], infra: "PDVSA (Petróleos de Venezuela, S.A.) — state oil company, severely degraded operationally. Chevron — received limited US OFAC license to operate. Repsol, ENI — maintain limited presence." },
...
// Each agent breaks the PST equilibrium through a distinct mechanism
export const ACTORS = [
