...
const SECTORS = [
  { sector: "Pharmaceuticals & Healthcare", domains: [
    { name: "Pharmacy Benefit Managers (PBMs)", beta: 6.35, revenue: "$60B (US PBM revenue)", risk: "Structural separation legislation. FTC investigation active. Spread pricing ban. Three companies control 80% of the market — they are the buyer, the seller, and the middleman.", timeline: "2–4 years" },
  ...
  { sector: "Food & Agriculture", domains: [
    { name: "Ultra-Processed Food (UPF)", beta: 4.06, revenue: "$450B (global UPF revenue)", risk: "Front-of-pack warning labels — Chile reduced UPF consumption 25% in two years. Marketing restrictions. School meal reformulation. The US has not tried.", timeline: "3–7 years" },
  ...
  { sector: "Financial Services & Consumer", domains: [
    { name: "Commercial Real Estate (CRE) Urban Hollowing", beta: 7.78, revenue: "$13B (CRE revenue)", risk: "$1.5T in distressed loans carried at 2019 valuations. San Francisco office vacancy: 37%. The loans say the buildings are worth what they were. They are not.", timeline: "1–3 years" },
    ...
    { name: "LIBOR / Financial Benchmark Manipulation", beta: 5.13, revenue: "$3.2B (trading desk revenues)", risk: "Self-referential benchmark: the banks setting the rate were the banks trading on it. $350T in contracts mispriced. Replaced by the Secured Overnight Financing Rate (SOFR) but the structural vulnerability — self-reported benchmarks — persists in other markets.", timeline: "Partially resolved" },
  ]},
  { sector: "Chemicals & Materials", domains: [
    { name: "PFAS / Forever Chemicals", beta: 5.31, revenue: "$187B (PFAS-using industries)", risk: "Comprehensive Environmental Response, Compensation, and Liability Act (CERCLA) strict liability. Class-wide production ban advancing in EU. Remediation costs projected at $100B+. The carbon-fluorine bond has never lost an arbitration.", timeline: "Active" },
    ...
    { name: "POPs Beyond PFAS", beta: 6.23, revenue: "$70B (persistent chemical industries)", risk: "Stockholm Convention listing takes 7–10 years per compound. Thousands of persistent chemicals in commerce without adequate assessment. The listing process is slower than the manufacturing process.", timeline: "3–10 years" },
  ]},
  { sector: "Defense & Aerospace", domains: [
    { name: "Weapons of Mass Destruction (WMD) Capability Diffusion", beta: 21.92, revenue: "$86.4B (dual-use tech revenue)", risk: "Export control expansion. AI-specific Wassenaar Arrangement (international export control regime) annexes. Once a capability is demonstrated, it cannot be undemonstrated. The knowledge diffuses.", timeline: "1–5 years" },
