...
const SECTORS = [
  ...
  { sector: "Biotech & Environment", domains: [
    ...
    { name: "Proof-of-Stake Protocols", beta: 2.1, revenue: "$80B+ (Proof-of-Stake market cap)", risk: "Welfare costs 97% lower than Proof-of-Work. The primary risk is validator concentration — Lido controls 28% of Ethereum staking. Not a priority domain.", timeline: "Low urgency" },
